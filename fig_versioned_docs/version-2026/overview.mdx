...
# 2026 FIG (Filing Instructions Guide) {#fig2026}
<div className="fig-section">
<h2 id="overview">1. &nbsp; What's in the FIG?</h2>


The 2026 Filing Instructions Guide (FIG) is a compendium of resources to help you file annual
HMDA data collected in 2026 with the Consumer Financial Protection Bureau (Bureau) in
2027. These resources are briefly described in this section and are further detailed throughout this document in individual sections.
...
### 1.1 &nbsp; &nbsp; Changes to the Submission Process for Data Collected in 2026
This section provides a summary of the changes made to the submission process for filing
HMDA data collected in 2026 with the Bureau.
...
### 1.2 &nbsp; &nbsp; 2026 File Specifications
This section provides information including valid values, how to format your loan/application
register, and how to file your HMDA data collected in 2026 with the Bureau.

This section may be useful for employees in a variety of roles, for example, your institution’s:
- Staff who collect, prepare, and submit HMDA data
- HMDA technology support staff

### 1.3 &nbsp; &nbsp; 2026 Data Specifications
...
There are no significant changes to the submission process for data collected in 2026 and
reported in 2027.
...
The required data fields for the 2026 data have not changed from the 2025 data collection and
reporting requirements. Please refer to Regulation C, the 2018 HMDA Rule, and the Data
Specification section for the 2026 requirements.

#### The loan/application register file format for submitting your HMDA data:

Financial institutions will submit data collected in a pipe delimited text file (.txt). Data fields will be separated by a pipe character, “|”, and will not be fixed length. Do not include leading zeros for the purpose of making a data field a specific number of characters. Do not use scientific notation in data field entries. Additional information regarding the loan/application register file format was previously found in our Knowledge Portal. We have replaced our Knowledge Portal with our Frequently Asked Questions Portal. Information regarding the loan/application register file format can be now found at "Frequently Asked Questions: HMDA Filing" located at https://ffiec.cfpb.gov/documentation/faq/filing-faq. For additional questions, contact hmdahelp@cfpb.gov.
...
Technical questions about reporting HMDA data collected in or before 2016 should be directed to cer@nara.gov.
...
## 3. &nbsp; 2026 File Specifications {#file-specifications}
...
Your HMDA data loan/application register will be submitted in a pipe (also referred to as vertical bar) delimited text file format. This means that: 
...
- Do not use scientific notation in data field entries (e.g. "102.03E4" or similarly formatted
scientific notation).
...
<hr />
<a id="2">2:</a> Reporting of the State data field is subject to the requirements of both Property Address, provided in 1003.4(a)(9)(i), and Property Location, provided in 1003.4(a)(9)(ii)[^2].

<a id="3">3:</a> Filers should continue to follow the race and ethnicity categories listed in [Regulation C, Appendix B](https://www.consumerfinance.gov/rules-policy/regulations/1003/b/)[^3].


</div>
<div className="fig-section">

## 4. &nbsp; 2026 Data Specifications {#data-specifications}

### 4.1 &nbsp; &nbsp; Introduction

This section provides instructions on entering data in the loan/application register for HMDA data collected in 2026. This document is not a substitute for Regulation C. Refer to Regulation C for a complete explanation of the reporting requirement for each data field.

Data fields are presented in the order they are recorded in the loan/application register. Data fields are identified by the corresponding 2026 File Specifications table and data field number, followed by the Regulation C paragraph containing the relevant reporting requirements. For example, (1-2) [Paragraph 5(a)(3)(i)](https://www.consumerfinance.gov/policy-compliance/rulemaking/regulations/1003/5/#a-3-i) refers to the data field listed in table 1, data field 2 in the 2026 File Specifications document, and the reporting requirement found at 12 CFR § 1003.5(a)(3)(i). The blue underlined words provide hyperlinks to the referenced Regulation C paragraph.
...
Example: If the data covers calendar year 2026, enter 2026.
...
Example: If the application was received on July 21, 2026, enter 20260721.
...
Example: If the action taken date is July 21, 2026, enter 20260721.
...
2. **Census Tract.** Enter the 11-digit census tract number as defined by the U.S. Census Bureau. Use the boundaries and codes effective January 1st, of  the calendar year covered by the loan/application register that it is reporting.
...
Example: If the property value is $350,500, enter 350500. If the property value is $350,500.24, enter 350500.24.
...
## 5. &nbsp; 2026 Edit Specifications {#edit-specifications}
...
### 5.2 &nbsp; &nbsp; 2026 New and Revised Edits 


#### TABLE 3: 2026 EDITS REVISED FROM 2025 {#table3}

<TableMaker jsonData={table3} tableNumber='3' tableName='Table 3' />

### 5.3 &nbsp; &nbsp; 2026 Edits
Table 4 through Table 8 list all of the edits for HMDA data collected in 2026 under the HMDA
...
section or the “Loan/Application Register” section. Edits for data collected in 2026 are grouped
...
#### TABLE 9: QUALITY EDITS FOR TRANSMITTAL SHEET AND LOAN/APPLICATION REGISTER

<TableMaker jsonData={table9} tableNumber='9' tableName='Table 9' />

#### TABLE 10: QUALITY EDITS FOR FILING INSTITUTION, REPORTING PERIOD, AND CONTACT INFORMATION (TRANSMITTAL SHEET)

<TableMaker jsonData={table10} tableNumber='10' tableName='Table 10' />
...
[^2]: Reporting of the State data field is subject to the requirements of both Property Address, provided in 1003.4(a)(9)(i), and Property Location, provided in 1003.4(a)(9)(ii).

[^3]: Filers should continue to follow the race and ethnicity categories listed in [Regulation C, Appendix B](https://www.consumerfinance.gov/rules-policy/regulations/1003/b/).