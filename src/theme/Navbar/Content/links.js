...
const latestFigYear = customFields.latestFigYear // Use variable when 2024 Annual Filing starts aka 2025 FIG.
  ...
  },
  {
    ...
    submenu: [
      ...
      { name: 'Modified LAR', href: '/data-publication/modified-lar/' },
      {
        ...
        href: '/data-publication/dynamic-national-loan-level-dataset/',
      },
      { name: 'Static Datasets' },
      {
        name: 'Snapshot Datasets',
        href: '/data-publication/snapshot-national-loan-level-dataset/',
      },
      {
        name: 'One-Year Datasets',
        href: '/data-publication/one-year-national-loan-level-dataset/',
      },
      {
        name: 'Three-Year Datasets',
        href: '/data-publication/three-year-national-loan-level-dataset/',
      },
      {
        name: 'Aggregate Reports',
        href: '/data-publication/aggregate-reports/',
      },
      {
        name: 'Disclosure Reports',
        href: '/data-publication/disclosure-reports/',
      },
    ],
  },
  {
    ...
    submenu: [
      {
        ...
        href: `/documentation/fig/2025/overview`,
      },
      ...
      {
        name: 'Developer APIs',
        href: '/documentation/category/developer-apis',
      },
