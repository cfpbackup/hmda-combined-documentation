...
<hr />
<a id="2">2:</a> Please see the [Rescission of Statement of Policy on Supervisory and Enforcement Practices Response](https://files.consumerfinance.gov/f/documents/cfpb_final-rescission_enf-and-supervisory-response_2021-03.pdf) to COVID-19 Pandemic for more information on quarterly reporting.
...
<a id="4">4:</a> Filers should continue to follow the race and ethnicity categories listed in [Regulation C, Appendix B](https://www.consumerfinance.gov/rules-policy/regulations/1003/b/).
...
2. **Census Tract.** Enter the 11-digit census tract number as defined by the U.S. Census Bureau and use the boundaries and codes in effect on January 1 of the calendar year covered by the loan/application register that it is reporting.
