...
Loan Amount|Numeric||Loan amounts are rounded to the midpoint of the nearest $10000 interval for which the reported value falls (For example a reported value of $117834 would be disclosed as $115000 as the midpoint between values $110000 and $120000).
